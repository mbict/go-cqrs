...
func (_m *MockEventStream) EventName() string {
	ret := _m.Called()
...
// OccurredAt provides a mock function with given fields:
func (_m *MockEventStream) OccurredAt() time.Time {
	ret := _m.Called()
...
func (_m *MockEventStream) Scan(_a0 Event) error {
	ret := _m.Called(_a0)
