...
func (_m *MockEventStore) LoadStream(aggregateName string, aggregateId AggregateId, version int) (EventStream, error) {
	ret := _m.Called(aggregateName, aggregateId, version)

	var r0 EventStream
	if rf, ok := ret.Get(0).(func(string, AggregateId, int) EventStream); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, AggregateId, int) error); ok {
